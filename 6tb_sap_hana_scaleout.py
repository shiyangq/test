...
# Build Date:   Mon Jun  7 10:57:54 PDT 2021
# ------------------------------------------------------------------------
...
def GenerateConfig(context):
  ...
  deployment_script_location = str(context.properties.get('deployment_script_location', 'https://storage.googleapis.com/cloudsapdeploy/deploymentmanager/202106071057/dm-templates'))
